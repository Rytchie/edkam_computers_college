...
const Footer: React.FC = () => {
  ...
  const SocialIcon: React.FC<{ href: string; path: string; }> = ({ href, path }) => (
    <a href={href} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-brand-accent-purple transition-colors">
  ...
  return (
    <footer className="bg-brand-dark-blue border-t border-slate-700/50">
