            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-6">
                    {FAQ_DATA.map((item: FAQItem) => (
                        <div key={item.id} className="bg-slate-800/60 backdrop-blur-sm rounded-xl shadow-lg overflow-hidden transition-all duration-300 ease-in-out hover:shadow-brand-accent-purple/30">
                            <button
                  ...
                  <svg className="w-6 h-6 text-brand-accent-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
                            ...
                            >
                                <p className="text-brand-secondary-text p-6 pt-0 text-base">
                                    {item.answer}
                                </p>
                            </div>
                        </div>
