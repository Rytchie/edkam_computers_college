...
const CoursesSection: React.FC<CoursesSectionProps> = ({ openApplicationModal }) => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
          {COURSES_DATA.map(course => (
            <CourseCard key={course.id} course={course} openApplicationModal={openApplicationModal} />
          ))}
        </div>
      </div>
    </section>
