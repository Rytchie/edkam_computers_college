...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ testimonial }) => {
  return (
    <div className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-xl shadow-xl h-full flex flex-col transition-shadow duration-300 ease-in-out hover:shadow-brand-accent-purple/30 w-96 flex-shrink-0">
      <div className="flex-grow mb-6">
        <p className="text-brand-light-text italic text-base">"{testimonial.feedback}"</p>
      </div>
